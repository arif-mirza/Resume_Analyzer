...
import DemoLink from "./DemoSection.jsx";
  ...
  return (
    ...
    <header className="bg-[#2D1B69] text-white py-4 px-6 lg:px-8 relative z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        {/* Logo */}
        <div className="text-2xl font-bold">RESUMEX</div>
        ...
        <nav className="hidden lg:flex items-center space-x-6">
          ...
          <div className="relative">
            ...
            {isProductsOpen && (
              <div className="absolute top-full left-0 mt-2 w-48 bg-[#c0adff] rounded-md shadow-lg py-2 z-50">
                <a
                  href="#"
                  className="block px-4 py-2 text-gray-800 hover:bg-[#e8e1ff]"
                >
                  Resume Scanner
                </a>
                <a
          ...
          {/* CTA Button */}
          <button
            className="bg-[#8B5CF6] hover:bg-[#7C3AED] text-white px-6 py-2 rounded-lg font-medium transition-all duration-300 transform hover:scale-105"
